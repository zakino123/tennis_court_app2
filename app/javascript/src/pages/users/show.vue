    ...
    <div class="user-info col-span-1 container mx-auto my-auto w-64">
      <div class="user-image justify-items-center mt-6 w-64 justify-center">
        ...
        <div class="text-center my-2 flex">
          <router-link :to="{ name: 'FollowingIndex', params: { id: user.id } }" class="text-gray-100 bg-indigo-500 border border-yellow-500 hover:text-indigo-400 hover:bg-white font-base rounded px-3 py-2 text-base mx-2" >フォロー{{ follow_count }}</router-link>
